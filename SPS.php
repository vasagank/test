                    ...
                    foreach ($queries as $query) {
                        ...
                        if($payload["build_mode"] == 1) {
                            ...
                            if(!empty($qf)) {
                                ...
                                $groups[$operator][] = $this->build_group_clause($query, $group_qf, false, $operator == "AND");
                            }
            ...
            foreach ($exact_query as $equery) {
                ...
                if ($payload["build_mode"] == 1) {
                    ...
                    if(!empty($exact_qf)) {
                        ...
                        $groups[$type][] = $this->build_group_clause($query, $group_qf, !$should_apply, (bool)$should_apply);
                    }
